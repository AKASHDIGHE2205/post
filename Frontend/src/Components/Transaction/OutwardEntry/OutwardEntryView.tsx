...
import { EditEntry, getAllOutView } from "../../../Services/Transaction/TransactionsAPI"
...
const OutwardEntryView: FC = () => {
    ...
    const handleCreateButton = () => {
        navigate("/outwardentry");
    };

    const handleEdit = (item: any) => {
        (document.getElementById('editOutModal') as HTMLDialogElement).showModal();
        setItems(item);
    };
        ...
        <>
            ...
            <div className="flex justify-center items-center ">
                <div className="overflow-x-auto w-full p-2 m-5 shadow-xl rounded-xl ">
                    <ReusableTHeader setSearchTerm={setSearchTerm} name="List of Outward Entries" createButtonAction={handleCreateButton} />
            ...
            <EditOutModal fetchData={handleDate} items={items} />
