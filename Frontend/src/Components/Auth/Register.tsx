        ...
        <form onSubmit={formik.handleSubmit} className="card-body">
          <div className="form-control">
            <label className="label flex">
              <span className="label-text font-semibold text-sm ">Username<span className="text-error ml-1">*</span></span>
            </label>
            ...
            <div className='flex space-x-4'>
            { formik.errors.firstname && formik.touched.firstname  ? (<div className='text-error text-sm w-full '>{formik.errors.firstname}</div>) : null}
            {formik.touched.lastname && formik.errors.lastname ? (<div className='text-error text-sm w-full  flex justify-end '>{formik.errors.lastname}</div>) : null}
            </div>
          </div>

          <div className="form-control">
            <label className="label">
              <span className="label-text font-semibold text-sm">Email<span className="text-error ml-1">*</span></span>
            </label>
            ...
            {formik.touched.email && formik.errors.email ? (<div className='text-error flex text-sm justify-center'>{formik.errors.email}</div>) : null}
          </div>

          <div className="form-control">
            <label className="label">
              <span className="label-text font-semibold text-sm">Mobile No<span className="text-error ml-1">*</span></span>
            </label>
            ...
            {formik.touched.phone && formik.errors.phone ? (<div className='text-error flex text-sm justify-center '>{formik.errors.phone}</div>) : null}
          </div>

          <div className="form-control relative">
            <label className="label">
              <span className="label-text font-semibold text-sm">Password<span className="text-error ml-1">*</span></span>
            </label>
            ...
            {formik.touched.password && formik.errors.password ? (<div className='text-error flex text-sm justify-center'>{formik.errors.password}</div>) : null}
          </div>


          <div className="form-control relative">
            <label className="label">
              <span className="label-text font-semibold text-sm"> Confirm Password<span className="text-error ml-1">*</span> </span>
            </label>
          ...
          {formik.touched.confirmPassword && formik.errors.confirmPassword ? (<div className='text-error flex justify-center'>{formik.errors.confirmPassword}</div>):null}
          </div>
